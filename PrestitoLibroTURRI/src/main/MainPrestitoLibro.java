...
public class MainPrestitoLibro {
	...
	public static void main(String args[]) {
		...
		System.out.println(p1.getNome() + "ha preso in prestito i libri: " + prestito1.getLibriInPrestito().toString() + "\nFino al:" + prestito1.getDataFinePrestito());
		System.out.println(p2.getNome() + "ha il seguente prestito: " + prestito2.toString());
	}
